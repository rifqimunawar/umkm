...
@section('module-content')
  ...
  <div class="panel panel-inverse">
    ...
    <div
      ...
      {{-- <a href="" class="btn btn-primary btn-sm">Tambah &ensp;<i class="fa fa-plus-square" aria-hidden="true"
          style="font-size: 12px"></i></a> --}}
      <a href="{{ route('laporan.export') }}" class="btn btn-warning btn-sm">
        <i class="fa fa-file-excel" style="font-size: 12px"></i> Export XLS
      </a>
      <div style="display: flex; gap: 10px;">

        <a href="javascript:void(0)" class="btn btn-warning btn-sm" onclick="printPage('{{ route('laporan.print') }}')">
          <i class="fa fa-print" aria-hidden="true"></i> Print
        </a>

        {{-- <a href="{{ route('laporan.print') }}" class="btn btn-danger btn-sm">
          <i class="fa fa-print" style="font-size: 12px"></i> Print Demo --}}
        </a>

        <a href="{{ route('laporan.pdf') }}" class="btn btn-warning btn-sm">
