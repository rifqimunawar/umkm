...
use Modules\Laporan\Exports\LaporanStokBahanExport;

class LaporanStokBahanController extends Controller
{
  public function getDataLaporan($start_date, $end_date)
  {
    $result = DB::table('bahans as a')
      ->whereNull('a.deleted_at')
      ->join('suppliers as b', 'a.supplier_id', '=', 'b.id')
      ->select('a.*', 'b.nama_supplier')
      ->orderBy('a.jumlah_bahan', 'asc')
  ...
  public function index(Request $request)
  {
    ...
    $title = 'Data Laporan Sisa Stok Bahan';

    return view('laporan::/laporan_bahan/index', [
      'title' => $title,
      'data' => $data,
  ...
  public function export(Request $request)
  {
    ...
    $end_date = $request->query('end_date')
      ...
      : Carbon::now()->endOfDay()->toDateTimeString();
    $data = $this->getDataLaporan($start_date, $end_date);
    return Excel::download(new LaporanStokBahanExport($data), 'laporan_pembelian.xlsx');
  }
  ...
  public function pdf(Request $request)
  {
    ...
    $html = view('laporan::laporan_bahan.pdf', [
      'title' => $title,
      'titleSm' => $titleSm,
      'data' => $data,
    ])->render();
