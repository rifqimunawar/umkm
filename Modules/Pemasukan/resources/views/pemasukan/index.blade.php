...
@section('module-content')
  ...
  <div class="panel panel-inverse">
    ...
    <div
      ...
      <a href="{{ route('pemasukan.create') }}" class="btn btn-primary btn-sm">Tambah &ensp;<i class="fa fa-plus-square"
          aria-hidden="true" style="font-size: 12px"></i></a>
      <div style="display: flex; gap: 10px;">
        {{-- <a href="{{ route('pemasukan.export') }}" class="btn btn-warning btn-sm">
        ...
        {{-- <a href="{{ route('pemasukan.pdf') }}" class="btn btn-warning btn-sm">
        ...
        <tbody>
          @foreach ($data as $item)
            <tr class="odd gradeX">
              ...
              <td>{{ $item->sumber }}</td>
              <td>{{ Fungsi::rupiah($item->nominal_pemasukan) }}</td>
              ...
              <td class="d-flex justify-content-center align-items-center text-center">
                ...
                <a href="{{ route('pemasukan.destroy', $item->id) }}" data-confirm-delete="true">
