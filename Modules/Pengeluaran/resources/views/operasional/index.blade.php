...
@section('module-content')
  ...
  <div class="panel panel-inverse">
    ...
    <div
      ...
      <a href="{{ route('operasional.create') }}" class="btn btn-primary btn-sm">Tambah &ensp;<i class="fa fa-plus-square"
          aria-hidden="true" style="font-size: 12px"></i></a>
      <div style="display: flex; gap: 10px;">
        {{-- <a href="{{ route('operasional.export') }}" class="btn btn-warning btn-sm">
        ...
        {{-- <a href="{{ route('operasional.pdf') }}" class="btn btn-warning btn-sm">
      ...
      <table id="data-table-default" width="100%" class="table table-striped table-bordered align-middle text-nowrap">
        <thead>
          <tr>
            ...
            <th class="text-nowrap">Operasional</th>
        ...
        <tbody>
          @foreach ($data as $item)
            <tr class="odd gradeX">
              ...
              <td>{{ Fungsi::rupiah($item->nominal_operasional) }}</td>
              <td>{{ $item->desc ?? '-' }}</td>
              <td class="d-flex justify-content-center align-items-center text-center">
                ...
                <a href="{{ route('operasional.destroy', $item->id) }}" data-confirm-delete="true">
