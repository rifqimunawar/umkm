...
@section('module-content')
          ...
          <form action="{{ route('produk.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group mb-3">
                  ...
                  <div class="input-group">
                    <input type="number" class="form-control" name="jumlah_produk" id="jumlah_produk"
                      placeholder="Kuantitas" required value="{{ old('jumlah_produk', $data->jumlah_produk ?? 1) }}">
                ...
                <div class="form-check form-switch mb-2" id="switch-hutang">
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      const panelBahan = document.getElementById("panel-bahan-produksi");
      const panelKomponen = document.getElementById("panel-komponen-produksi");
      const switchHutang = document.getElementById("switch-hutang");
      panelBahan.style.display = produksiSwitch.checked ? "block" : "none";
      panelKomponen.style.display = produksiSwitch.checked ? "block" : "none";
      switchHutang.style.display = produksiSwitch.checked ? "none" : "block";
      produksiSwitch.addEventListener("change", function() {
        panelBahan.style.display = this.checked ? "block" : "none";
        panelKomponen.style.display = this.checked ? "block" : "none";
        switchHutang.style.display = this.checked ? "none" : "block";
      });
