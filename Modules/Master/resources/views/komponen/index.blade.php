...
@section('module-content')
  ...
  <div class="panel panel-inverse">
    ...
    <div
      ...
      <a href="{{ route('master_komponen.create') }}" class="btn btn-primary btn-sm">Tambah &ensp;<i
          class="fa fa-plus-square" aria-hidden="true" style="font-size: 12px"></i></a>
      <div style="display: flex; gap: 10px;">
        {{-- <a href="{{ route('master_komponen.export') }}" class="btn btn-warning btn-sm">
        ...
        {{-- <a href="{{ route('master_komponen.pdf') }}" class="btn btn-warning btn-sm">
    ...
    <div class="panel-body">
      <table id="data-table-default" width="100%" class="table table-striped table-bordered align-middle text-nowrap">
        <thead>
          <tr>
            <th width="1%"></th>
            <th class="text-nowrap">Nama Komponen Produksi</th>
          ...
          @foreach ($data as $item)
            <tr class="odd gradeX">
              ...
              <td class="d-flex justify-content-center align-items-center text-center">
                <a href="{{ route('master_komponen.edit', $item->id) }}">
                  <i class="fa fa-pencil-square" style="font-size: 14px; margin-right:5px"></i>
                </a>
                <a href="{{ route('master_komponen.destroy', $item->id) }}" data-confirm-delete="true">
